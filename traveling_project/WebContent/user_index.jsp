  ...
  <body>
    ...
    <main>
      ...
      <section class="hotel_recommend">
        ...
        <div class="slider rec_slider">
          <div>
            <a href="#">
              ...
              <p>₩ 320,000~</p>
              <div class="rec_review review">
                "혼자 조용히 쉬고싶어서 예약했어요. 예전에 친구가 묵었을 때 놀러간 적이 있는데 좋았던 기억이 있어서 다시 방문했습니다. 두시반 경에
                도착했는데 흔쾌히 체크인 해주셔서 정말 감사했고 마침 조식 프로모션 기간이라 무료로 바우처를 받아서 그것도 정말 감사했어요. 조식은
                3층에서 먹을 수 있는데 종류가 아주 다양하진 않았지만 다 맛있었어요. 이 호텔은 위치가 아주 좋아요. 대중교통편도 좋고 주변이 큰 상권이라
                볼거리 먹을거리가 넘쳐나요 객실은 좁은 편이지만 창이 커서 답답하지 않고 길에서 들리는 소음을 제외하고는 조용한 편이에요. 침구도 편해서
                푹 잤습니다. 아쉬운 점은 요금인데 재작년말에 6만원 정도였는데 1.5배 이상 인상이 되었네요ㅠ 그래도 재방문 의사 충분히 있습니다! 아
                그리고 체크아웃이 12시라 여유있어서 그것도 만족이에요"
              </div>
            </a>
          </div>
          <div>
          ...
          <div>
            <a href="#">
              <div class="image_slider">
                <img src="images/hotel_rec_image7.webp" alt="" />
                <img src="images/hotel_rec_image8.webp" alt="" />
              </div>
              <h3>더 퍼스트 스테이</h3>
        ...
        <span class="arrow ir_pm">left_arrow</span>
        <span class="arrow ir_pm">right_arrow</span>
      </section>
      <!-- 국내 인기 여행지 -->
      <section class="korea_popular_region">
        ...
        <div class="slider">
          <a href="#">
            <div><img src="images/jeju.jpg" alt="" /></div>
            <h2>제주</h2>
            <p>숙소 4,878개</p>
          </a>
          <a href="#">
            <div><img src="images/seoul.jpg" alt="" /></div>
            <h2>서울</h2>
            <p>숙소 5,923개</p>
          </a>
          <a href="#">
            <div><img src="images/busan.jpg" alt="" /></div>
            <h2>부산</h2>
            <p>숙소 2,719개</p>
          </a>
          <a href="#">
            <div><img src="images/sokcho.jpg" alt="" /></div>
            <h2>속초</h2>
            <p>숙소 797개</p>
          </a>
          <a href="#">
            <div><img src="images/incheon.jpg" alt="" /></div>
            <h2>인천</h2>
            <p>숙소 2,154개</p>
          </a>
          <a href="#">
            <div><img src="images/gangneung.jpg" alt="" /></div>
            <h2>강릉</h2>
            <p>숙소 1,181개</p>
          </a>
        </div>
        ...
        <div class="swiper mySwiper banner">
          ...
          <div class="slider swiper-wrapper">
            ...
            <div class="swiper-slide banner">
              <a href="#">
                <div class="image_slider">
                  <img src="images/accomodation_near_me_image13.jpg" alt="" />
                  <img src="images/accomodation_near_me_image14.jpg" alt="" />
                </div>
                <h3>디그니티 호텔</h3>
            ...
            <div class="swiper-slide banner">
              <a href="#">
                <div class="image_slider">
                  <img src="images/accomodation_near_me_image15.jpg" alt="" />
                  <img src="images/accomodation_near_me_image16.jpg" alt="" />
                </div>
                <h3>호텔 탑스텐 정동진</h3>
            ...
            <div class="swiper-slide banner">
              <a href="#">
                <div class="image_slider">
                  <img src="images/accomodation_near_me_image17.jpg" alt="" />
                  <img src="images/accomodation_near_me_image18.jpg" alt="" />
                </div>
                <h3>파크 하비오 호텔</h3>
      ...
      <section class="popular_accomodation">
        ...
        <div class="slider pop_slider">
          <div>
            <a href="#">
              <div class="image_slider">
                <img src="images/pop_image1.jpg" alt="" />
                <img src="images/pop_image2.jpg" alt="" />
              </div>
              <h3>어반스테이 속초등대</h3>
              <p>강원도 속초시 영랑해안8길 11</p>
              <p>₩ 63,000</p>
              <div class="review pop_review">
                "혼자 조용히 쉬고싶어서 예약했어요. 예전에 친구가 묵었을 때 놀러간 적이 있는데 좋았던 기억이 있어서 다시 방문했습니다. 두시반 경에
                도착했는데 흔쾌히 체크인 해주셔서 정말 감사했고 마침 조식 프로모션 기간이라 무료로 바우처를 받아서 그것도 정말 감사했어요. 조식은
                3층에서 먹을 수 있는데 종류가 아주 다양하진 않았지만 다 맛있었어요. 이 호텔은 위치가 아주 좋아요. 대중교통편도 좋고 주변이 큰 상권이라
                볼거리 먹을거리가 넘쳐나요 객실은 좁은 편이지만 창이 커서 답답하지 않고 길에서 들리는 소음을 제외하고는 조용한 편이에요. 침구도 편해서
          ...
          <div>
            <a href="#">
              <div class="image_slider">
                <img src="images/pop_image3.jpg" alt="" />
                <img src="images/pop_image4.jpg" alt="" />
              </div>
              <h3>호텔 이스티아</h3>
              <p>강원도 춘천시 남춘로 22</p>
              <p>₩ 45,000</p>
          ...
          <div>
            <a href="#">
              <div class="image_slider">
                <img src="images/pop_image5.jpg" alt="" />
                <img src="images/pop_image6.jpg" alt="" />
              </div>
              <h3>휘닉스평창 리조트</h3>
          ...
          <div>
            <a href="#">
              <div class="image_slider">
                <img src="images/pop_image7.jpg" alt="" />
                <img src="images/pop_image8.jpg" alt="" />
              </div>
              <h3>아이체크호텔</h3>
          ...
          <div>
            <a href="#">
              <div class="image_slider">
                <img src="images/pop_image9.jpg" alt="" />
                <img src="images/pop_image10.jpg" alt="" />
              </div>
              <h3>춘천 더 잭슨나인스 호텔</h3>
              <p>강원도 춘천시 중앙로 193</p>
              <p>₩ 105,000</p>
          ...
          <div>
            <a href="#">
              <div class="image_slider">
                <img src="images/pop_image11.jpg" alt="" />
                <img src="images/pop_image12.jpg" alt="" />
              </div>
              <h3>강릉 세인트존스호텔</h3>
              <p>강원도 강릉시 창해로 307</p>
              <p>₩ 199,400</p>
          ...
          <div>
            <a href="#">
              <div class="image_slider">
                <img src="images/pop_image13.jpg" alt="" />
                <img src="images/pop_image14.jpg" alt="" />
              </div>
              <h3>스카이베이 호텔 경포</h3>
              <p>강원특별자치도 강릉시 해안로 476</p>
              <p>₩ 253,000</p>
          ...
          <div>
            <a href="#">
              <div class="image_slider">
                <img src="images/pop_image15.jpg" alt="" />
                <img src="images/pop_image16.jpg" alt="" />
              </div>
              <h3>쏠비치 삼척 리조트</h3>
